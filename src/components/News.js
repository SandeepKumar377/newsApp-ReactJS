...
const News = (props) => {
    ...
    useEffect(() => {
        document.title = `News Hunter - ${capitalizeFirstLetter(props.category)}`;
        updateNews();
    ...
    return (
        <div className="container">
            <h2 className="text-center bg-success m-2 p-2">Top {capitalizeFirstLetter(props.category)} News </h2>
            {loading && <Spinner />}
            <InfiniteScroll
